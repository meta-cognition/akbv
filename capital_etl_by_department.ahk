...
fund_column_max					:= 77	; CHECK THE ABS EXPORT, THESE CHANGE
...
loop 
{
	...
	link_data 							.= CSV_ReadCell("sankey_csv_identifier", current_row, project_title_column) "^" CSV_ReadCell("sankey_csv_identifier", current_row, web_column) rn
	...
	{ 
		...
		this_refnum	:= CSV_ReadCell("sankey_csv_identifier", current_row, web_column)
