InitializeDepartments()
{
	global
	department_list := []
	department_list.push({abs_name: "Governor", readable_name:  "Governor's Office" })
	...
	department_list.push({abs_name: "Fish and Game", readable_name:  "Department of Fish and Game" })
