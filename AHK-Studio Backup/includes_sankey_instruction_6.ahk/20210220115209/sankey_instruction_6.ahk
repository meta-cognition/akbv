...
{	
		...
		filter_csv_file := department_csv_file
			...
			{	;departmental 
				...
				load_and_apply_filter_to_csv(include_filters, exclude_filters)
				build_links(fund_column, rdu_column, fund_column, value_column, fund_column, 1, false, false)
				
				include_filters := "no-filters"
				exclude_filters := {(line_column): "AP"}
				load_and_apply_filter_to_csv(include_filters, exclude_filters)
				build_links(rdu_column, component_column, fund_column, value_column, fund_column, 1, false, false)
