...
<div class='plot-legend'>
	<!-- div class='legend-title'>Fund Types</div> -->
		<div class='legend-scale'>
			...
			<div style='border:1px solid black; text-align:center; box-shadow:none; margin:15px auto 15px auto; font-size: 80`%; line-height: 18px; padding:0px;'>$ in Thousands (1,000)</div>
		</div>
