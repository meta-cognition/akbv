...
html_color_legend =
(
<div class='my-legend' style='font-family: "Open Sans", verdana, arial, sans-serif; box-shadow: 5px 5px 10px; margin: 15px auto 15px auto; padding:5px 5px 5px 15px; border:1px solid black; max-width: 300px !important;'>
