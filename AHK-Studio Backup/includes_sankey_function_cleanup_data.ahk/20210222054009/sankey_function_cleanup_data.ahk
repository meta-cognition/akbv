cleanup_data(cleanup_capital_flag = false)
{
	...
	{        
		...
		{
		; Capital Department Name Cleanup for Fund Category, FIND -> REPLACE
		...
		; Capital Cleanup for statewide, FIND -> REPLACE (replace with standardized ABS name, department_list.absname)
		...
		csv_find_replace("Highways, Aviation and Faciliti", "Highways, Aviation and Facilities")
		csv_find_replace("Design, Engineering and Constru", "Design, Engineering and Construction")
