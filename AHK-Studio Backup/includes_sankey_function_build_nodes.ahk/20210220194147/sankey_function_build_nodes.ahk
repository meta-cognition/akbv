			...
			if (show_values_in_labels = true)
			{
				...
				{					
					...
					else 
					{
						...
						{
							first_occurence_row := CSV_SearchColumn("sankey_csv_identifier", current_column, fund_column)
							this_node_meta := "(" CSV_ReadCell("sankey_csv_identifier", first_occurence_row, group_column) ")"
						}
					}
				}
			}
