			...
			if (show_values_in_labels = true)
			{
				...
				{					
					...
					else 
					{
						...
						is_this_a_fund := CSV_SearchColumn("sankey_csv_identifier", current_column, fund_column)
						if (is_this_a_fund)
						{
							this_node_meta := CSV_ReadCell("sankey_csv_identifier", is_this_a_fund, group_column)
						}
					}
				}
			}
