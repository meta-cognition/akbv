...
{	
	...
	FileRead, department_overview_file_contents, % this_output_file
	...
	StringReplace, department_overview_file_contents, department_overview_file_contents, % "@@@" abs_department_name "@@@", % department_folder , All
	
	FileDelete, % this_output_file
	FileAppend, % department_overview_file_contents, % this_output_file
